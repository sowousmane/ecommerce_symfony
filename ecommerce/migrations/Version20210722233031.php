 ...
 */
final class Version20210722233031 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE history CHANGE sent_at sent_at VARCHAR(45) NOT NULL'); 
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE history CHANGE sent_at sent_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
