...
final class Version20210710001340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD command_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT NOT NULL, CHANGE price price DOUBLE PRECISION NOT NULL');
